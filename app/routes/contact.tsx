              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href={`tel:${t.footer.phoneValue.replace(/\s/g, '')}`} className="hover:text-blue-900">
                        {t.footer.phoneValue}
                      </a>
                    </p>
                  </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      <a href={`mailto:${t.footer.emailValue}`} className="hover:text-blue-900">
                        {t.footer.emailValue}
                      </a>
                    </p>
                  </div>
